...
work_path = "/net/shendure/vol10/projects/cxqiu/nobackup/work/sam_tf/analysis/monoclonal_EB_TF_screen_sci"

adata = sc.read_mtx(os.path.join(work_path, 'gene_count_1.mtx'))
pdata = pd.read_csv(os.path.join(work_path, 'df_cell_1.csv'), index_col = 0)
fdata = pd.read_csv("/net/shendure/vol2/projects/cxqiu/work/jax/rna_seq/df_gene.csv", index_col = 0)
